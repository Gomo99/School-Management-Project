        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsDeleted = table.Column<string>(type: "nvarchar(5)", maxLength: 5, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "AssessmentTypeID", "AssessmentTypeDescription", "IsDeleted" },
                values: new object[,]
                {
                    { 1, "Formal written examination", "False" },
                    { 2, "Short knowledge test", "False" },
                    { 3, "Practical or theoretical work assignment", "False" },
                    { 4, "Extended practical project work", "False" },
                    { 5, "Oral presentation of work", "False" },
                    { 6, "Hands-on practical assessment", "False" },
                    { 7, "Analysis of real-world scenarios", "False" },
                    { 8, "Collection of work samples", "False" },
                    { 9, "Scientific laboratory report", "False" },
                    { 10, "Academic research paper", "False" }
                });
